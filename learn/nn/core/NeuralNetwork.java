...
abstract public class NeuralNetwork {
	...
	/**
	 * Return the accuracy (proportion correct) for this NeuralNetwork on the given
	 * list of Examples.
	 */
	...
	/**
	 * Run a k-fold cross-validation experiment on this NeuralNetwork using the
	 * given Examples and return the average accuracy over the k trials.
	 */
	public double kFoldCrossValidate(List<Example> examples, int k, Trainer trainer, Tester tester, boolean print) {
	...
	/**
	 * Interface implemented by objects that can train a NeuralNetwork. This will
	 * typically involve a closure that specifies additional arguments for the
	 * training, such as the learning rate alpha.
	 */
